...
public class AutoBuildAndPush : EditorWindow
{
    ...
    private const string GameSlot = "dungeon36";
    private const string BuildPath = @"C:\Unity assets\GMTK2026-WebBuild"; // Thư mục sẽ build ra

    [MenuItem("Itch Tools/Build and Push to Itch.io")]
